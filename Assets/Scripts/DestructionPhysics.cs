...
public class DestructionPhysics : MonoBehaviour
{
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(DestructionPhysics original)
        {
            ...
            GameObject.GetComponent<Renderer>().material = carry;
            ...
            var meshDestroy = GameObject.AddComponent<DestructionPhysics>();
